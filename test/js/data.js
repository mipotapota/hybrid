...
async function showFavorites() {
    ...
    try {
        ...
        if (pageTitle) {
            pageTitle.innerHTML = `
                <button onclick="backToSettings()" style="background: none; border: none; color: var(--primary-color); font-size: 18px; cursor: pointer; padding: 0; margin-right: 12px;">
